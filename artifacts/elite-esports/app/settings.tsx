...
const ICON_BOX_WIDTH = 36;
const ROW_GAP = 14;
const DIVIDER_LEFT = ROW_PADDING + ICON_BOX_WIDTH + ROW_GAP;
...
const styles = StyleSheet.create({
  ...
  divider: { height: 1, backgroundColor: Colors.border.subtle, marginLeft: DIVIDER_LEFT },
  version: {
    textAlign: 'center',
    fontSize: 12,
