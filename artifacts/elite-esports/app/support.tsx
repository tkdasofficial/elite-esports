...
export default function SupportScreen() {
  ...
  const handleSubmit = async () => {
    ...
    if (error) Alert.alert('Error', error.message);
      ...
      Alert.alert('Submitted!', 'Our team will respond within 24 hours.');
    }
  };
...
const styles = StyleSheet.create({
  ...
  banner: {
    backgroundColor: Colors.background.card, borderRadius: 16, padding: 24, alignItems: 'center',
    gap: 8, marginBottom: 24, borderWidth: 1, borderColor: Colors.border.default,
  },
