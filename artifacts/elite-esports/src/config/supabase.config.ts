export const SUPABASE_CONFIG = {
  url: process.env.EXPO_PUBLIC_SUPABASE_URL || 'https://azxhcalksgudjemwjekd.supabase.co',
  ...
  projectId: process.env.EXPO_PUBLIC_SUPABASE_PROJECT_ID || 'azxhcalksgudjemwjekd',
} as const;
