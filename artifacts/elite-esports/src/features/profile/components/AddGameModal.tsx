                    ...
                    <View style={styles.gameInfo}>
                      ...
                      {alreadyAdded && (
                        <View style={styles.addedBadge}>
                          <Ionicons name="checkmark-circle" size={21} color={colors.status.success} />
          ...
          >
            ...
            >
              <View style={styles.selectedGameChip}>
                {selectedGame.banner_url ? (
                  ...
                  <View style={[styles.chipBanner, styles.gameBannerPlaceholder]}>
                    <Ionicons name="game-controller-outline" size={21} color={colors.text.muted} />
                  </View>
                )}
              ...
              <View style={styles.inputWrapper}>
                <Ionicons name="person-outline" size={21} color={colors.text.muted} style={styles.inputIcon} />
                <TextInput
                  style={styles.input}
                  value={inGameName}
              ...
              <View style={styles.inputWrapper}>
                <Ionicons name="key-outline" size={21} color={colors.text.muted} style={styles.inputIcon} />
                <TextInput
                  ref={uidRef}
                  style={styles.input}
                  value={uid}
