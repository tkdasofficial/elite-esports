...
const styles = StyleSheet.create({
  ...
  form: { gap: 12 },
  input: { height: 52, backgroundColor: Colors.appSurface, borderRadius: 14, paddingHorizontal: 16, fontSize: 17, color: Colors.textPrimary },
  error: { fontSize: 13, color: Colors.brandLive },
  btn: { height: 54, backgroundColor: Colors.brandPrimary, borderRadius: 14, alignItems: 'center', justifyContent: 'center' },
