...
const styles = StyleSheet.create({
  ...
  backBtn: { paddingHorizontal: 24, paddingVertical: 10, backgroundColor: Colors.brandPrimary, borderRadius: 999 },
  ...
  ctaFee: {},
  ctaFeeLabel: { fontSize: 10, color: Colors.textMuted, fontWeight: '600', letterSpacing: 0.5 },
  ctaFeeValue: { fontSize: 20, fontWeight: '700', color: Colors.textPrimary },
  joinBtn: {
